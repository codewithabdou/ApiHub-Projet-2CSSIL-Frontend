...
function EndpointDetails(props:any) {
  ...
  return (
    ...
    <Accordion type="single" collapsible className='w-full border-[2px] border-[#184173] p-2 rounded-[7px] bg-white overflow-x-hidden'>
...
{props.description}    
          ...
          <h1 className='sm:text-xl text-lg font-medium' >Corps de la requette:</h1>
...
/>
<h1 className='sm:text-xl text-lg font-medium' >Corps de la réponse:</h1>
<CodeBlock
