...
import { createDiscussionSchema, createDisscussionRequest } from '@typings/api/disscussionTypes';
...
function AddDisscussionForm(props:any) {
  ...
  return (
    ...
    <Sheet>
  <SheetTrigger>
    <Button className='sm:w-64 w-48 text-sm'>Ouvrir une disscussion</Button>
  </SheetTrigger>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="Titre de la discussion" {...field}></Input>
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder="Question" {...field}></Textarea>
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
