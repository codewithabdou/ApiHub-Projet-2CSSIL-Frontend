...
const Nosservices = ()  => {
  return (
    <div className="w-full my-10 flex flex-col gap-y-[50px] justify-center items-center">
      ...
      <div className="xl:w-[80%] p-12  w-[95%]   md:h-fill  bg-white rounded-[20px] shadow-md  flex justify-center items-center border-[1px]">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-24">
          <div className="max-w-lg md:max-w-xl max-h-md p-4 md:p-8  bg-white border border-gray-200 rounded-xl shadow-sm  ">
            <Image
              className="float-right "
              src={IMAGES.Nosservices[0].RestAPI}
              width={60}
              height={70}
              alt="Banner"
            />
            ...
            <p className="mb-3 text-lg text-gray-500   justify-content max-w-[40ch] ">
          ...
          <div className="max-w-lg md:max-w-xl max-h-md p-4 md:p-8  bg-white border border-gray-200 rounded-xl shadow-sm  ">
            <Image
              className="float-right "
              src={IMAGES.Nosservices[0].GoogleDocs}
              width={60}
              height={70}
              alt="Banner"
            />
          ...
          <div className="max-w-lg md:max-w-xl max-h-md p-4 md:p-8  bg-white border border-gray-200 rounded-xl shadow-sm  ">
            <Image
              className="float-right "
              src={IMAGES.Nosservices[0].StackofMoney}
              width={60}
              height={70}
              alt="Banner"
            />
