...
const Nosservices = () => {
  return (
    <div className="w-full my-10 flex flex-col gap-y-[50px] justify-center items-center">
      ...
      <div className="xl:w-[80%] p-4  w-[95%]  h-1/2 md:h-[400px]  bg-white rounded-[20px] shadow-md  flex justify-center items-center border-[1px]">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="max-w-md md:max-w-xs max-h-lg p-4  bg-white border border-gray-200 rounded-xl shadow-sm  ">
            <Image
            ...
            <p className="mb-3 text-gray-500 max-w-[26ch] ">
