...
function Footer() {
  return (
    <div className="flex flex-col w-full  justify-end items-center">
      <div className="w-full  h-[120px] bg-primary text-white md:text-xl text-lg font-bold flex items-center justify-center ">
        1<span className="text-secondary">00</span>1 API @{" "}
        {new Date().getFullYear()} All rights reserved
      </div>
      <div className="w-full h-[7px] bg-secondary"></div>
      <div className="w-full h-[120px] bg-primary flex justify-center items-center  ">
