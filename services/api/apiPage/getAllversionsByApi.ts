...
async function getAllVersionsByApi(id:Number):Promise<{data:successGetVersionsResponse,status:string,message:string}|ErrorType>{
    try {
        ...
        const data = await response.json();
          ...
          return  {data:data,status:"success",message:"got all versions succesfully"} ;
    } catch (error:any) {
        return {
            status: "server error",
